...
public class ILostCommandTest {
    ...
    public void setUp() throws Exception {
        ...
        iLostCommand = new ILostCommand(matchServiceMock, mock(BotCommandParser.class));
    ...
    public void callWithPlayer1Matching_shouldSaveWinner() throws Exception {
        ...
        iLostCommand.execute(createMessageMock("!iwon", AUTHOR_ID));
    ...
    public void callOnAlreadyDecidedMatch_shouldSaveNewWinner() throws Exception {
        ...
        iLostCommand.execute(createMessageMock("!iwon", OTHER_ID));
        verify(matchServiceMock, times(1)).saveMatch(matchMock);
