 ...
 */
public class PatchedRequestBuffer {
     ...
     */
    public static <T> RequestFuture<T> request(final IRequest<T> request) {
    ...
    public interface IRequest<T> {
         ...
         */
        T request() throws HTTP429Exception, DiscordException;
    }
     ...
     */
    @FunctionalInterface
    public interface IVoidRequest extends sx.blah.discord.util.RequestBuffer.IRequest<Object> {
    ...
    public static class RequestFuture<T> implements Future<T>, Delayed {
        ...
        public RequestFuture(final IRequest<T> request) {
        ...
        protected boolean tryAgain() {
            if (!isCancelled()) {
                try {
                    ...
                    timeForNextRequest = System.currentTimeMillis() + 1000;
                }
            }
    ...
    private static class RequestTimerTask<T> extends TimerTask {
        ...
        private RequestTimerTask(final RequestFuture<T> future) {
            this.future = future;
        }
